...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice team skills and play competitive games",
        "schedule": "Tuesdays, Thursdays, Saturdays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["james@mergington.edu", "hailey@mergington.edu"]
    },
    "Yoga Club": {
    ...
    "Art Studio": {
        ...
        "max_participants": 18,
        "participants": ["isabella@mergington.edu", "david@mergington.edu"]
    },
    "Drama Club": {
